...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Mr GOJO",
    ownernumber: process.env.Owner_Number || "50944060792",
    ...
    sessionId: process.env.SESSION_ID || "CBjl4Jtk6_A_N_Y_A_V_2_WrxrcEEifxE",
